...
from transformers import CLIPTextModel, CLIPTokenizer, CLIPImageProcessor, CLIPVisionModel, CLIPModel
import diffusers
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                noise_pred = self._forward( # noise_pred.shape=[2,4,4,32,32]
                    ...
                    encoder_hidden_states=encoder_hidden_states, # shape=[2,77,1024]
...
def load_mvcontrol_pipeline(
    pretrained_model_name_or_path,
    pretrained_controlnet_name_or_path,
    weights_dtype,
    num_views,
    device,
    enable_unet_multi_branch=False,
    multi_branch_type='v1',
):
    if enable_unet_multi_branch:
